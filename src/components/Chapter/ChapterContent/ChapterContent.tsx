...
export function ChapterContent({theLast, theFirst, content, titleNovel, titleChapter, goPrev, goNext, goMenu} : ChapterContentProps) {
  ...
  return(
    <div className="chapterContentContainer">
      ...
      <span dangerouslySetInnerHTML={{__html: content? content : 'Ops... Algo deu errado.' }}></span>
